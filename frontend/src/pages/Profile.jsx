  ...
  return (
    <div dir="rtl" style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        {/* 2026-06-02 — The "ערים שמעניינות אותי" card moved inline to
            /market-discovery (CityFilterBar at the top of the page).
            The PATCH /me/specialty-cities endpoint stays — the inline
            bar persists through it — so a single source of truth still
            drives the feed scope. */}
...
// 2026-06-02 — SpecialtyCitiesSection removed. The "ערים שמעניינות אותי"
// surface moved inline to the top of /market-discovery (see CityFilterBar).
// The PATCH /me/specialty-cities endpoint stays — the inline bar persists
// through it — so a single source of truth still drives the feed scope.
