...
export function buildAiGreeting({ isPremium = false, userName = '' } = {}) {
  ...
  const body = [
    `${hello} אני **Estia AI** — היד-ימין שלך לניהול לידים, נכסים ועסקאות.`,
    '',
    'אני יכול/ה לעזור לך עם:',
    '- חיפוש בלידים שלך — "אילו לידים חמים יש לי בתל אביב?"',
    '- ניסוח הודעות WhatsApp ותזכורות לפי הסטטוס של הליד',
    '- התאמת נכסים ללידים שלך והפך — "איזה נכס מתאים לליד החם האחרון?"',
