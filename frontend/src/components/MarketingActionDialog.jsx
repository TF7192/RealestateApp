...
const ACTION_CONFIG = {
  ...
  madlan: { label: 'מדל״ן', kind: 'link', hint: 'כתובת המודעה ב-madlan' },
  ...
  externalCoop: { label: 'שיתוף פעולה חיצוני', kind: 'notes', hint: 'שם הסוכן/משרד ששותף' },
  ...
  flyers: { label: 'פלאיירים', kind: 'notes', hint: 'כמות ומיקום' },
  newspaper: { label: 'עיתון', kind: 'link', hint: 'קישור למודעה באונליין, או שם העיתון' },
