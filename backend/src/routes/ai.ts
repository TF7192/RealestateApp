  ...
  app.post(
    ...
    async (req, reply) => {
      ...
      const SYSTEM = [
        ...
        '- אחרי שהכלי החזיר תוצאות: צטט/י את שם הכפתור והנתיב **בדיוק כמו שהוחזרו** (אל תתרגם/י, אל תמציא/י). הצג/י כרשימה ממוספרת קצרה.',
        '- אם הכלי החזיר תוצאות אבל top score &lt; 5 או שלא נראה רלוונטי — אמור/י "אני לא בטוח/ה איפה זה במערכת, נסה/י את עמוד העזרה (/help)" במקום להמציא.',
