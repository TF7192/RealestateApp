  ...
  app.post(
    ...
    async (req, reply) => {
      ...
      const SYSTEM = [
        ...
        '  • "התאמות חכמות" (lead-ai-matches, drawer בעמוד ליד) ≠ "התאמות פומביות" (property-public-matches, שיתוף למאגר ציבורי). אם השאלה על "פומבי/פומביות/ציבורי/מאגר" — זה תמיד public-matches.',
        '  • "שיתוף נכס" (property-share, ShareDialog עם WhatsApp/SMS) ≠ "העברת נכס" (property-transfer, העברת בעלות לסוכן רשום) ≠ "שיתוף למאגר הפומבי" (property-public-matches).',
